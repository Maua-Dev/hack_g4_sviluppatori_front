...
function Ingredientes(){
    ...
    const [inputMarca, setInputMarca] = React.useState("");
    ...
    function createIngredientes(){
        let mensagem = {}
        if (inputNome === "" || inputQuantidade === "" || inputMarca === ""){
            mensagem = {
                titulo: "Erro",
            }
        }
            ...
            <Modal  show={isShow} onHide={() => setIsShow(false)}>
                ...
                <Modal.Body>
                    ...
                    <div>
                        ...
                        <input type="text" value={inputMarca} id="marca" name="marca" onChange={(event) => setInputMarca(event.target.value)} placeholder="Pomarola..."/>
                    </div>
                </Modal.Body>
                <Modal.Footer>
                    ...
                    <Button variant="dark" onClick={() => createIngredientes()}>
                        Adicionar
                    </Button>
                </Modal.Footer>
            </Modal>
                    ...
                    <div className="col-md-3 m-0 p-0">
                        <div id="botoes">
                            ...
                            <a href="/admin/financeiro">
                                <button className="d-block mb-3 pe-4" id="botao-financeiro">
