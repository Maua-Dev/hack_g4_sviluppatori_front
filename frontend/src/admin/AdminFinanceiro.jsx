        ...
        <div>
            ...
            <Modal.Header closeButton>
                ...
                <Modal.Body>
                    ...
                    <div>
                        ...
                        <input type="text" value={inputQuantia} id="quantia" name="quantia"  onChange={(event) => setInputQuantia(event.target.value)} placeholder="520..." />
                    </div>
                    <div>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="dark" onClick={() => cadastrarFinanceiro()}>
                        Adicionar
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            <div className="container-fluid m-0 p-0">
                <div className="row m-0 p-0">
                    ...
                    <div className="col-12 col-md-8 me-1" id={styles["tabela"]}>
                        <table>
                            <thead>
                                <tr>
                                    <th>Identificação</th>
                            ...
                            <tbody>
                                {financeiro.map((financeiro, i) => (
                                    <tr key={i}>
                                        <td>{financeiro.identificacao}</td>
                                        <td>R$ {financeiro.quantia}</td>
                                        <td>{financeiro.status}</td>
                                    </tr>
                                ))}
                                <tr>
                                    <td className={styles["add-button"]}>
